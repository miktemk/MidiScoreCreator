...
public class BendUpSmoothMod extends NoteModifier
{
    ...
    public void paintButton(Graphics2D g, JToggleButton b)
    {
        ...
        g.draw(new Arc2D.Double(0, b.getHeight()/3, b.getWidth(), b.getHeight()/3, 270, 90, Arc2D.OPEN));
    }
    public void modifyNote(Note note)
    {
        note.addModifier(new BendEnd_Rough(bend, BendEnd_Rough.UP, choke));
        note.addModifier(new DecrescEndEvent(bend, 0, choke));
    }
    public void update()
    {
