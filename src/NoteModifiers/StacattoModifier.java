...
public class StacattoModifier extends NoteModifier
{
    public void paintButton(Graphics2D g, JToggleButton b)
    {
        ...
        g.fill(new Ellipse2D.Double(b.getWidth()/2-2, b.getHeight()*(7.5/9), 4, 4));
    }
    public void modifyNote(Note note)
    {
        if(!note.stacatto()) note.setSlurm(Note.STACATTO);
